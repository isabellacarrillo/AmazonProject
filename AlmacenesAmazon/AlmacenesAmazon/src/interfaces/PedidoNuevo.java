...
public class PedidoNuevo extends javax.swing.JFrame {
    ...
    /**
     * Retorna storageComboBox
     *
     * @return javax.swing.JComboBox
     */
    public javax.swing.JComboBox<String> getWarehouseCB() {
     ...
     * @return javax.swing.JComboBox
     */
    public javax.swing.JComboBox<String> getProductCB() {
        return this.productComboBox;
    }

    /**
     * Retorna productQtyTextField
     *
     * @retorna javax.swing.JComboBox
     */
    public javax.swing.JTextField getProductAmountTF() {
        return this.productQtyTextField;
    }

    public javax.swing.JTextArea getOrderTA() {
...
//        getWarehouseCB().removeAllItems();
    ...
    private void storageComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_storageComboBoxItemStateChanged
        InterfaceFunctions.setAvailableProducts(getWarehouseCB().getSelectedItem().toString());
    ...
    private void addProductButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addProductButtonActionPerformed
        ...
        if ((getProductCB().getSelectedItem() != null)) {
            if (InterfaceFunctions.isNum(getProductAmountTF().getText())) {
                if (Integer.parseInt(getProductAmountTF().getText()) > 0) {
                    InterfaceFunctions.updateTFOrder(getOrderTA().getText());
                    getWarehouseCB().setEnabled(false);
                    getProductCB().removeItem(getProductCB().getSelectedItem());
                } else {
    ...
    private void completeOrderButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_completeOrderButtonActionPerformed
       if (!getOrderTA().getText().isEmpty()) {
            InterfaceFunctions.completePedidoNuevo(getOrderTA().getText(), getWarehouseCB().getSelectedItem().toString());
       } else {
